...
export const placeholderProducts: Product[] = [
  ...
  { id: "prod009", name: "Jelly Pudding", category: "Dessert", price: 2.80, wholesalePrice: 2.50, stock: 60, imageUrl: "https://images.unsplash.com/photo-1724931641963-f4a12f8fd3e1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxMHx8ZGVzc2VydCUyMHByb2R1Y3R8ZW58MHx8fHwxNzUwMDkyOTgyfDA&ixlib=rb-4.1.0&q=80&w=1080", description: "Colorful fruit jelly pudding.", sku: "DES002", reorderLevel: 10, aiHint: "dessert product" },
  { id: "prod010", name: "Faluda", category: "Drink", price: 3.00, wholesalePrice: 2.70, stock: 40, imageUrl: "https://images.unsplash.com/photo-1648220818316-876d53dad8d5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwyfHxkcmluayUyMHByb2R1Y3R8ZW58MHx8fHwxNzUwMDkyOTgxfDA&ixlib=rb-4.1.0&q=80&w=1080", description: "Sweet rose-flavored milk drink with vermicelli and basil seeds.", sku: "DRK003", reorderLevel: 10, aiHint: "drink product" },
  ...
  { id: "prod012", name: "Curd", category: "Curd", price: 4.00, wholesalePrice: 3.70, stock: 70, imageUrl: "https://images.unsplash.com/photo-1740126101919-f5abd65c09e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw3fHxjdXJkJTIwcHJvZHVjdHxlbnwwfHx8fDE3NTAwOTI5ODF8MA&ixlib=rb-4.1.0&q=80&w=1080", description: "Thick and creamy curd.", sku: "CRD001", reorderLevel: 15, aiHint: "curd product" },
];
