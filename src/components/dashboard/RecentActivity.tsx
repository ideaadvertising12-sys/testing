...
const recentActivities: ActivityItem[] = [
  ...placeholderSales.slice(0, 2).map((sale, index): ActivityItem => ({
    ...
    description: `${sale.items.length} items, Total: $${sale.totalAmount.toFixed(2)}`,
  ...
  })),
  {
    ...
    description: `Category: ${placeholderProducts[4].category}, Price: $${placeholderProducts[4].price.toFixed(2)}`,
